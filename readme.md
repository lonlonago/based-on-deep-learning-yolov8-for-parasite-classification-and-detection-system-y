# Based on deep learning YOLOv8 for parasite classification and detection system (YOLOv

## Body

Parasitic worm identification detection system based on deep learning YOLOv8
